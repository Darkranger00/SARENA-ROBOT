...
# from ADIL.convert import convert_gif
from sarena import dispatcher
from sarena import telethn as bot
from sarena.events import register as asau
...
def convert_gif(input):
    """ғᴜɴᴄᴛɪᴏɴ ᴛᴏ ᴄᴏɴᴠᴇʀᴛ ᴍᴘ4 ᴛᴏ ᴡᴇʙᴍ(ᴠᴘ9)!(lucky randi)"""
