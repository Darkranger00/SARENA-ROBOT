...
from sarena.modules import ALL_MODULES
from sarena.modules.helper_funcs.chat_status import is_user_admin
from sarena.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Naina.modules." + module_name)
